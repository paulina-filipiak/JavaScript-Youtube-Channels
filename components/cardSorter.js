...
// 		const sorted = cardsArray.sort(sortByTitle)
// 		sorted.forEach((el) =>
...
// 		const sorted = cardsArray.sort(sortBySubscribers)
// 		sorted.forEach((el) =>
// 			document.querySelector(".js-content").appendChild(el)
// 		)
// 	}
...
// 		const cardsArray = Array.from(cardsFromDOM)
// 		const sorted = cardsArray.sort(sortByVideos)
// 		sorted.forEach((el) =>
// 			document.querySelector(".js-content").appendChild(el)
// 		)
// 	}
...
// 		const cardsArray = Array.from(cardsFromDOM)
// 		const sorted = cardsArray.sort(sortByViews)
// 		sorted.forEach((el) =>
// 			document.querySelector(".js-content").appendChild(el)
// 		)
// 	}
